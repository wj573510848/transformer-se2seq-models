...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 24 11:15:15 2019
...
class test_model:
    ...
    def predict_one_sentence(self,sentence):
        sentence_split=self.tokenizer.tokenize(sentence,self.config.source_language_type,self.config.source_language_lower)
        s_ids,_=self.data_tools.encode(sentence_split)
